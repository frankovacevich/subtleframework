...
PlotlyObject = class PlotlyObject{
    ...
    add_scatter(data, parameters){
        ...
        */
        ...
        let params_ = {
            name: "",
            color: getComputedStyle(document.documentElement).getPropertyValue('--colors-primary')[this.traces.length],
            show_markers: false,
            show_lines: true,
    ...
    add_piechart(data, parameters){
        ...
        */
        ...
        let COLOR_PALETTE = [ "#5bbadc", "#3d5afe", "#00e676", "#76ff03", "#c6ff00", "#ffc400", "#ff3d00", "#f50057", "#d500f9", "#1de9b6", ];
    ...
    /*add_gantt(data, parameters){
        ...
        let params_ = {
            name: "",
            colors: getComputedStyle(document.documentElement).getPropertyValue('--colors-primary'),
    ...
    add_boxandwhiskers(data, parameters){
        ...
        */
        ...
        let params_ = {
            name: "",
            color: getComputedStyle(document.documentElement).getPropertyValue('--colors-primary'),
            show_outliers: true,
            show_mean: true,
            zindex: 0,
        }
...
exports.PlotlyObject = PlotlyObject;
